...
const Rules =  () => {
  ...
  return (
		<div className="page-container rules">
		  <div className='rules__block'><img src='/src/img/rules/read.png' className='rules__img' /></div>
		  <div className="rules">
